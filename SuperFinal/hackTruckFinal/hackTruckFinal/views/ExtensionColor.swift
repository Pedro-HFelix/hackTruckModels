...
extension Color {
    ...
    static let darkGrayGreen = Color(UIColor(red: 47/255, green: 54/255, blue: 53/255, alpha: 0.2))
    static let lightOrange = Color(red: 255/255, green: 204/255, blue: 153/255)
